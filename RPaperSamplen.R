...
E.ci.table4.bread<-rbind(E.ci.T4.appearance,E.ci.T4.aroma,E.ci.T4.taste,E.ci.T4.texture,E.ci.T4.color)
...
E.ci.table4.cookie<-rbind(E.ci.T4.appearance,E.ci.T4.aroma,E.ci.T4.taste,E.ci.T4.texture,E.ci.T4.color)
...
E.ci.table4.muffin<-rbind(E.ci.T4.appearance,E.ci.T4.aroma,E.ci.T4.taste,E.ci.T4.texture,E.ci.T4.color)
...
E.ci.table4.pancake<-rbind(E.ci.T4.appearance,E.ci.T4.aroma,E.ci.T4.taste,E.ci.T4.texture,E.ci.T4.color)
...
E.ci.table4.sfiha<-rbind(E.ci.T4.appearance,E.ci.T4.aroma,E.ci.T4.taste,E.ci.T4.texture,E.ci.T4.color)
...
#### TABLE 5 ####
#### Create dataframe for bread=color gender=female
E.ci.f<-data.frame(n=integer(),
                 gender=numeric(),
                 food=numeric(),
                 variable=numeric(),
                 lower=numeric(),
...
for (i in 2:5) {
  ...
  E.ci.f[i,]<-c(i,"female","bread","color",samplen(i))
...
#### Create dataframe for bread=color gender=male
E.ci<-data.frame(n=integer(),
                 gender=numeric(),
                 food=numeric(),
                 variable=numeric(),
                 lower=numeric(),
...
E.ci[i,]<-c(i,"male","bread","color",samplen(i))
